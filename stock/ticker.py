...
app.layout = html.Div(
    [
        html.Div(
            [
                html.H3("Stock symbols:", style={"paddingRight": "30px"}),
                dcc.Input(id="my_stock_picker", value=[""], multiple=True),
            ],
            style={"display": "none", "verticalAlign": "top", "width": "30%"},
        ),
        html.Div(
            [
                html.H3("Normalised prices:", style={"paddingRight": "30px"}),
                dcc.Input(id="my_prices", value=[""], multiple=True),
            ],
            style={"display": "none", "verticalAlign": "top", "width": "30%"},
        ),
        html.Div(
            [
                html.H3("First Purchase Date:", style={"paddingRight": "30px"}),
                dcc.Input(id="first_dates", value=[""], multiple=True),
            ],
            style={"display": "none", "verticalAlign": "top", "width": "30%"},
        ),
        dcc.Graph(
...
def update_graph(stock_ticker, prices, first_date, **kwargs):
    ...
    fig = {"data": traces, "layout": {"title": "Stock ticker"}}
    return fig
